    ...
    return( <div>
        ...
        <form className={ifEdit ? 'inputsEdit': 'inputsSub'}>
                <div className='headInput'>
                    <p className='ids '>#{form.id} <i className="fa-solid fa-person-military-rifle"></i></p>
                    <button className="btn btn-outline-danger  delets " onClick={(e)=>deletForm(e,'MilitaryService',form.id)}><i class="fa-solid fa-trash"></i></button>
                </div>
            <div className="container text-center">
                ...
                <div className="row">
                    <div className='col m-3'>
                        <button className={ifEdit ?"btn btn-warning":"btn btn-success"} onClick={(e)=>addMainInfo(e,formik.values,form.father,form.id)}>Submit</button>
                    </div>
                </div>
            </div>
