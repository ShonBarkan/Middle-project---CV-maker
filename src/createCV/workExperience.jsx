    ...
    return( <div>
        ...
        <form className={ifEdit ? 'inputsEdit': 'inputsSub'}>
                <div className='headInput'>
                    <p className='ids '>#{form.id} <i className="fa-sharp fa-solid fa-briefcase"></i></p>
                    <button className="btn btn-outline-danger  delets " onClick={(e)=>deletForm(e,'WorkExperience',form.id)}><i class="fa-solid fa-trash"></i></button>
                </div>
